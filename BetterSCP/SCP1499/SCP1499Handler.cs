    ...
    public class SCP1499Handler : Module
    {
        ...
        private void Player_InteractingDoor(Exiled.Events.EventArgs.InteractingDoorEventArgs ev)
        {
            ...
            if (!ev.Player.IsBypassModeEnabled && ev.Player.Role != RoleType.Scp079)
            {
                ...
                {
                    ev.IsAllowed = false;
                    Gamer.Mistaken.Systems.GUI.PseudoGUIHandler.Set(ev.Player, "scp1499Door", Gamer.Mistaken.Systems.GUI.PseudoGUIHandler.Position.MIDDLE, plugin.ReadTranslation("Info_012_Denied"), 5);
