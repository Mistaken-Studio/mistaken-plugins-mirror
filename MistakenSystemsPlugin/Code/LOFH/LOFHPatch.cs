                                    ...
                                    try
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if(Systems.Patches.NicknamePatch.RealNicknames.TryGetValue(hub.characterClassManager.UserId, out string fname))
                                ...
                                try
                                {
                                    ...
                                    if (GeneratePlayerList)
                                    {
                                        foreach (Player player in RealPlayers.List)
                                        {
                                            ...
                                            if (!Systems.Patches.NicknamePatch.RealNicknames.TryGetValue(player.UserId, out string fname))
                                                fname = null;
